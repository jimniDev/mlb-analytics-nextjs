...
const DashboardHeader: React.FC = () => {
  ...
  return (
    <div className="relative w-full font-sans">
      ...
      <div
        className={`fixed top-0 left-0 w-full bg-white shadow-md z-50 transition-all duration-500 ease-in-out transform ${
        ...
        <div className="container max-w-5xl mx-auto px-4 py-2">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center mb-2 md:mb-0">
              ...
              />
              <div className="uppercase font-bold text-[#383838] text-xs ml-2">
                2021-2024
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto mt-4 sm:mt-8 justify-center">
          ...
          <div className="flex flex-col items-center justify-center px-4 sm:px-0">
            <p className="max-w-full sm:max-w-[52rem] text-sm sm:text-base font-light mt-4 sm:mt-6 mb-4 sm:mb-6">
              Major League Baseball (MLB) is unique in the fact that teams do
              not have a cap for how much they can pay their players, so each
              team can spend as much as they want on player salaries. This can
              be a bit controversial, because fans might begin to think that the
              team that spends the most money is guaranteed to win the most.
              History shows that this is not always the case, and thus the
              purpose of this visualization is to present users with data that
              tells the story of what teams are most successful at efficiently
              spending money.
            </p>
          </div>
        </div>
