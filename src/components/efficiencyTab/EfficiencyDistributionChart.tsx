    ...
    <div className="h-96">
        ...
        >
          ...
          <Tooltip
            ...
            labelFormatter={(value) => {
              const team = enhancedData.find(
                (item) => item.displayName === value
              );
              return team
                ? `${team.team} (${Math.round(team.avgWins)} Wins)`
                : value;
            }}
      ...
      <div className="text-center text-xs text-gray-500 mt-2">
        <span className="inline-block mr-3">
          <span className="inline-block w-3 h-3 bg-green-600 mr-1"></span>Low
          Cost per Win
        </span>
        <span className="inline-block mr-3">
          <span
        ...
        <span className="inline-block">
          <span className="inline-block w-3 h-3 bg-red-500 mr-1"></span>High
          Cost per Win
        </span>
      </div>
    </div>
