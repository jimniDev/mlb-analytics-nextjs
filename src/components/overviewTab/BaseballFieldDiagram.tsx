...
const BaseballFieldDiagram = () => {
  ...
  const handlePositionHover = (position: Position, event: React.MouseEvent) => {
        ...
        <>
          <div className="mt-6">
            <svg viewBox="0 0 966 800" className="w-full">
              ...
              {/* Infield Dirt */}
              <path
                d="M473 483 L483 333 L683 483 L483 673 L283 483 Z"
                fill="#c87f46"
              />
              ...
              <path
                d="M 483 483 L 283 483 A 200 200 0 0 1 683 483 Z"
                fill="#c87f46"
              />

              {/* Infield Grass with Stripes */}
              <path
                d="M483 333 L633 483 L483 633 L333 483 Z"
                fill="url(#grassPattern)"
              />
              ...
              {/* Catcher's Box */}
              <path
                d="M453 680 A30 30 0 0 0 513 680"
                fill="none"
                stroke="white"
                strokeWidth="2"
              />
