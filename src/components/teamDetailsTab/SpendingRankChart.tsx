      ...
      <div className="h-48 flex items-center justify-center">
        <div className="grid grid-cols-4 gap-2 w-full">
          {teamData.payrollHistory.map((yearData, index) => {
            ...
            const yearTeams = allData.filter(
              (team) => team.Year === yearData.year
            );
            // Sort by payroll
            ...
            // Find rank
            const rank =
              sortedYearTeams.findIndex(
                (team) => team.Team === teamData.teamCode
              ) + 1;
