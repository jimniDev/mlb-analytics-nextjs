...
export const getTeamColor = (teamCode: TeamCode): string => {
...
export const getTeamLogo = (teamCode: TeamCode): string => {
  const teamIds: Record<TeamCode, number> = {
    ARI: 109,
    ATL: 144,
    BAL: 110,
    BOS: 111,
...
export const getTeamName = (teamCode: TeamCode): string => {
  const teamNames: Record<TeamCode, string> = {
